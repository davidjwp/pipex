...
*
*	test-cases
*	/if a command that does not exist is given (check)
...
*	/you should also check if you have access to those files like the right permissions (check)
*		.use access() to do that 
*	/no memory leaks (check)
*	/if the pipe buffer overflows (check)
...
*	/make sure to close the file descriptors (check)
*	/check for command access (check)
*	/make sure to dup the fd's right, DO NOT REPLACE STDOUT/STDIN it's always the other way (check)
*	/if there is no environment  (check)
*/
